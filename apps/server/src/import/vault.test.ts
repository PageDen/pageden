...
describe("import path helpers", () => {
  ...
  it("normalizes paths and ignores vault internals", () => {
    ...
    expect(vault.isIgnoredPath("__MACOSX/vault/._note.md")).toBe(true);
    expect(vault.isIgnoredPath("vault/._note.md")).toBe(true);
    expect(vault.isIgnoredPath("vault/.DS_Store")).toBe(true);
